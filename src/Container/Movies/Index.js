...
import CardComponents from '../Home/CardComponents';
import PaginationComponent from '../../Components/Pagination';

import LeftListBarComponent from '../../Components/LeftBar';
import useGenres from '../../Hooks/useGenres';
import SearchBarComponents from '../../Components/SearchBox';
            ...
            <Container>
                <Row>
                    <Col className='col-12'>
                        <section>
                            <h1 className='txtCenter'>Movies For You</h1>
                        ...
                        <Row>
                                {
                                    content && content.length > 0 ? content.map((item, index)=>{
                                        return (<CardComponents key={index} data={item} mediaType="movie"/>)
                                    }) : 'Loading ....'
                                }
